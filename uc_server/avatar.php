...
$ava_id=DB::result_first('SELECT ava FROM %t WHERE uid=%d', array('shequ_user',$uid));
$rand_no=!empty($ava_id) ? (int)$ava_id :'noavatar';
...
if(file_exists(dirname(__FILE__).'/'.$avatar)) {
	...
	$avatar_url = 'images/noavatar/'.$size.'/'.$rand_no.'.png';
}
