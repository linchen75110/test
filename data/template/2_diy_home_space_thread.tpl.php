...
<div class="bm bw0">
<div class="bm_c">
<?php } } else { include template('common/header'); ?><style id="diy_style" type="text/css"></style>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"></div><!--[/diy]-->
</div>
<div id="ct">
...
<a href="home.php?mod=space&amp;do=thread&amp;view=me&amp;type=postcomment" <?php echo $orderactives['postcomment'];?>>点评</a><span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=notice" id="myprompt_new" <?php if($_G['member']['newprompt']) { ?>class="a new"<?php } ?>>提醒<?php if($_G['member']['newprompt']) { ?>(<?php echo $_G['member']['newprompt'];?>)<?php } ?></a>
